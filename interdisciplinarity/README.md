...
| 认知架构 (SOAR, ACT-R) | Agent 认知架构 | → [`agentic/01-core-concepts/cognitive-architectures-intro/`](../agentic/01-core-concepts/cognitive-architectures-intro/) |
...
| 外部学科概念 | AI/ML 对应 | 关联目录 |
|---|---|---|
| 语用学 (Pragmatics) / 言语行为理论 | 对话 Agent 的意图理解与生成 | → [`agentic/02-cognitive-capabilities/`](../agentic/02-cognitive-capabilities/) |
| 乔姆斯基层级 / 普遍语法 | LLM 语法能力的理论边界 | → [`llm/02-model-zoo/emergent-abilities/`](../llm/02-model-zoo/emergent-abilities/) |
| 话语分析 (Discourse Analysis) | 长文本连贯性、多轮对话管理 | → [`llm/04-serving/prompt-engineering/`](../llm/04-serving/prompt-engineering/) |
| 语义学 (Semantics) / 组合性 | LLM 的语义组合能力与幻觉 | → [`llm/07-explainability/`](../llm/07-explainability/) |
| 社会语言学 (Sociolinguistics) | 多语言/多文化 LLM 对齐 | → [`llm/06-applications/safety-and-alignment/`](../llm/06-applications/safety-and-alignment/) |
...
| 自调节系统 (Self-regulation) | Agent 自反思与纠错 | → [`agentic/02-cognitive-capabilities/self-reflection/`](../agentic/02-cognitive-capabilities/self-reflection/) |
| 稳态 (Homeostasis) | Agent 目标维持与安全约束 | → [`agentic/04-environments/sandboxing-and-safety/`](../agentic/04-environments/sandboxing-and-safety/) |
| 黑箱系统 (Black Box) | 可解释性与机制可解释性 | → [`llm/07-explainability/mechanistic/`](../llm/07-explainability/mechanistic/) |
...
| 外部学科概念 | AI/ML 对应 | 关联目录 |
|---|---|---|
| 韦伯式科层制 | 层级式 Multi-Agent | → [`agentic/03-agent-architectures/multi-agent-systems/`](../agentic/03-agent-architectures/multi-agent-systems/) |
| 市场机制 / 价格信号 | 竞价式 Agent 协调 | → [`agentic/03-agent-architectures/multi-agent-systems/`](../agentic/03-agent-architectures/multi-agent-systems/) |
...
| 社会资本 / 信任 | Agent 间信任评估 | → [`agentic/06-evaluation/safety-and-robustness/`](../agentic/06-evaluation/safety-and-robustness/) |
| 组织学习 | Multi-Agent 经验共享 | → [`agentic/02-cognitive-capabilities/memory/`](../agentic/02-cognitive-capabilities/memory/) |
...
| 外部学科概念 | AI/ML 对应 | 关联目录 |
|---|---|---|
| 责任归属 (Liability) | Agent 行为的法律责任主体 | → [`agentic/06-evaluation/safety-and-robustness/`](../agentic/06-evaluation/safety-and-robustness/) |
| 合规 (Compliance) | 数据合规、模型合规审计 | → [`llm/06-applications/safety-and-alignment/`](../llm/06-applications/safety-and-alignment/) |
| 权利理论 (Rights Theory) | AI 权利、人格与道德地位 | → [`llm/06-applications/social-impact/`](../llm/06-applications/social-impact/) |
| 规则制定 (Rulemaking) | AI 治理框架与标准制定 | → [`agentic/04-environments/sandboxing-and-safety/`](../agentic/04-environments/sandboxing-and-safety/) |
